...
";
        ...
        INamedTypeSymbol? transientAttribute = compilation.GetTypeByMetadataName("Signalbox.Engine.Utilities.TransientAttribute")!;
        INamedTypeSymbol? orderAttribute = compilation.GetTypeByMetadataName("Signalbox.Engine.Utilities.OrderAttribute")!;
        INamedTypeSymbol? layoutOfT = compilation.GetTypeByMetadataName("Signalbox.Engine.Entity.ILayout`1")!.ConstructUnboundGenericType();
        INamedTypeSymbol? filteredLayout = compilation.GetTypeByMetadataName("Signalbox.Engine.Entity.FilteredLayout`1")!;

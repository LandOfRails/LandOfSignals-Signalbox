...
public class MiniMapScreen : IScreen, IInteractionHandler, ITogglable
{
    ...
    public MiniMapScreen(IMapRenderer mapRenderer, ILayout<Track> trackLayout, IPixelMapper pixelMapper)
    {
        ...
        _mapRenderer.Changed += (s, e) => Changed?.Invoke(this, EventArgs.Empty);
    }
